...
- [x] 11.7 实现 Agent 接口其他方法
  - Prompt 方法 (TODO: 完整实现)
  - SetSessionMode 方法 (TODO: 完整实现)
  - Authenticate 方法 (TODO: 完整实现)
  - ✅ 整体 98.6% 覆盖率
...
- [x] 14.1 实现客户端 API (client.go)
  - 编写 API 测试
  - 实现 Client 结构
  - 实现便捷方法
  - ✅ 96.9% 覆盖率

- [x] 14.2 实现配置选项 (options.go)
  - 编写选项测试
  - 实现选项模式
  - 实现默认配置
  - ✅ 96.9% 覆盖率
